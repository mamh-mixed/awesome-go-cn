...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2026-03-27 07:32:40(每隔1天同步一次)**
...
- [excelize](https://github.com/xuri/excelize) **star:20430** Golang图书馆阅读和写作微软Excel&trade;(XLSX)文件。   [![近一周有更新][G]](https://github.com/xuri/excelize)   [![godoc][D]](https://godoc.org/github.com/xuri/excelize)
...
- [mdns](https://github.com/hashicorp/mdns) **star:1352** 简单mDNS(Multicast DNS)客户端/服务器库。   [![godoc][D]](https://godoc.org/github.com/hashicorp/mdns)
...
- [tls-client](https://github.com/bogdanfinn/tls-client) **star:1529** net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.   [![godoc][D]](https://godoc.org/github.com/bogdanfinn/tls-client)
- [surf](https://github.com/enetx/surf) **star:1380** Advanced HTTP client with HTTP/1.1, HTTP/2, HTTP/3 (QUIC), SOCKS5 proxy support and browser-grade TLS fingerprinting.   [![godoc][D]](https://godoc.org/github.com/enetx/surf)
...
- [GORM](https://github.com/go-gorm/gorm) **star:39657** 一个出色的 ORM 库。主要目标是对开发人员友好。   [![近一周有更新][G]](https://github.com/go-gorm/gorm)   [![godoc][D]](https://godoc.org/github.com/go-gorm/gorm)
- [ent](https://github.com/facebook/ent) **star:16992** 一个用于Go的实体框架。用于建模和查询数据的简单而强大的ORM。   [![近一周有更新][G]](https://github.com/facebook/ent)   [![godoc][D]](https://godoc.org/github.com/facebook/ent)
...
- [bun](https://github.com/uptrace/bun) **star:4723** SQL-first Golang ORM. Successor of go-pg.   [![近一周有更新][G]](https://github.com/uptrace/bun)   [![godoc][D]](https://godoc.org/github.com/uptrace/bun)
...
- [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) **star:1679** 一个灵活而强大的SQL字符串构建器库。   [![近一周有更新][G]](https://github.com/huandu/go-sqlbuilder)   [![godoc][D]](https://godoc.org/github.com/huandu/go-sqlbuilder)
...
- [syft](https://github.com/anchore/syft) **star:8581** A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.   [![近一周有更新][G]](https://github.com/anchore/syft)   [![godoc][D]](https://godoc.org/github.com/anchore/syft)
...
- [jaeger](https://github.com/jaegertracing/jaeger) **star:22624** 分布式跟踪系统。   [![近一周有更新][G]](https://github.com/jaegertracing/jaeger)   [![godoc][D]](https://godoc.org/github.com/jaegertracing/jaeger)
- [ebpf-go](https://github.com/cilium/ebpf) **star:7615** Provides utilities for loading, compiling, and debugging eBPF programs.   [![近一周有更新][G]](https://github.com/cilium/ebpf)   [![godoc][D]](https://godoc.org/github.com/cilium/ebpf)
- [pixie](https://github.com/pixie-labs/pixie) **star:6396** 通过eBPF对Golang应用程序没有检测跟踪。   [![近一周有更新][G]](https://github.com/pixie-labs/pixie)
...
- [dasel](https://github.com/tomwright/dasel) **star:7887** 使用命令行中的选择器查询和更新数据结构。与jq/yq类似，但支持JSON、YAML、TOML和XML，运行时依赖关系为零。   [![godoc][D]](https://godoc.org/github.com/tomwright/dasel)
...
- [gonum](https://github.com/gonum/gonum) **star:8335** Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。   [![近一周有更新][G]](https://github.com/gonum/gonum)   [![godoc][D]](https://godoc.org/github.com/gonum/gonum)
...
- [age](https://github.com/FiloSottile/age) **star:21756** 一个简单、现代和安全的加密工具(和Go库)，具有小的显式密钥，没有配置选项，并且具有unix风格的可组合性。   [![近一周有更新][G]](https://github.com/FiloSottile/age)   [![godoc][D]](https://godoc.org/github.com/FiloSottile/age)
- [lego](https://github.com/go-acme/lego) **star:9350** 纯 Go ACME 客户端库及命令行工具   [![近一周有更新][G]](https://github.com/go-acme/lego)   [![godoc][D]](https://godoc.org/github.com/go-acme/lego)
- [CertMagic](https://github.com/caddyserver/certmagic) **star:5496** 成熟、健壮和强大的ACME客户端集成，用于完全托管的TLS证书颁发和续签。   [![godoc][D]](https://godoc.org/github.com/caddyserver/certmagic)
...
- [Coraza](https://github.com/corazawaf/coraza) **star:3376** 企业级、modsecurity和OWASP CRS兼容WAF库。   [![近一周有更新][G]](https://github.com/corazawaf/coraza)   [![godoc][D]](https://godoc.org/github.com/corazawaf/coraza)
...
- [beelzebub](https://github.com/mariocandela/beelzebub) **star:1916** A secure low code honeypot framework, leveraging AI for System Virtualization.   [![近一周有更新][G]](https://github.com/mariocandela/beelzebub)   [![godoc][D]](https://godoc.org/github.com/mariocandela/beelzebub)
...
- [jsoniter](https://github.com/json-iterator/go) **star:13922** 高性能，100% 兼容的“encoding/json” 替代品   [![godoc][D]](https://godoc.org/github.com/json-iterator/go)   [![归档项目][Archived]](https://github.com/json-iterator/go)
...
- [Caddy](https://github.com/caddyserver/caddy) **star:71124** Caddy是另一种HTTP/2 web服务器，易于配置和使用。   [![近一周有更新][G]](https://github.com/caddyserver/caddy)   [![godoc][D]](https://godoc.org/github.com/caddyserver/caddy)
- [consul](https://www.consul.io/)  Consul 是一个用于服务发现、监控和配置的工具
- [minio](https://github.com/minio/minio) **star:60555** Minio是一个分布式对象存储服务器。   [![godoc][D]](https://godoc.org/github.com/minio/minio)   [![归档项目][Archived]](https://github.com/minio/minio)
- [pocketbase](https://github.com/pocketbase/pocketbase) **star:57153** PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.   [![godoc][D]](https://godoc.org/github.com/pocketbase/pocketbase)
- [etcd](https://github.com/etcd-io/etcd) **star:51709** 为共享配置和服务发现提供高可用的键值存储。   [![近一周有更新][G]](https://github.com/etcd-io/etcd)   [![godoc][D]](https://godoc.org/github.com/etcd-io/etcd)
- [SFTPGo](https://github.com/drakkan/sftpgo) **star:11841** 完全功能和高度可配置的SFTP服务器与可选的FTP/S和WebDAV支持。它可以为本地文件系统和云存储后端(如S3和谷歌云存储)提供服务。   [![近一周有更新][G]](https://github.com/drakkan/sftpgo)   [![godoc][D]](https://godoc.org/github.com/drakkan/sftpgo)
...
- [Wish](https://github.com/charmbracelet/wish) **star:5063** 制作SSH应用程序，就像这样!   [![godoc][D]](https://godoc.org/github.com/charmbracelet/wish)
...
- [templ](https://github.com/a-h/templ) **star:10186** A HTML templating language that has great developer tooling.   [![近一周有更新][G]](https://github.com/a-h/templ)   [![godoc][D]](https://godoc.org/github.com/a-h/templ)
...
- [keploy](https://github.com/keploy/keploy) **star:16591** Generate Testcase and Data Mocks from API calls automatically.   [![近一周有更新][G]](https://github.com/keploy/keploy)   [![godoc][D]](https://godoc.org/github.com/keploy/keploy)
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) **star:4742** A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.   [![近一周有更新][G]](https://github.com/testcontainers/testcontainers-go)   [![godoc][D]](https://godoc.org/github.com/testcontainers/testcontainers-go)
...
- [godog](https://github.com/cucumber/godog) **star:2604** Cucumber BDD framework for Go.   [![近一周有更新][G]](https://github.com/cucumber/godog)   [![godoc][D]](https://godoc.org/github.com/cucumber/godog)
...
- [go-httpbin](https://github.com/mccutchen/go-httpbin) **star:829** HTTP testing and debugging tool with various endpoints for client testing.   [![近一周有更新][G]](https://github.com/mccutchen/go-httpbin)   [![godoc][D]](https://godoc.org/github.com/mccutchen/go-httpbin)
...
- [mockery](https://github.com/vektra/mockery) **star:7038** 生成Go界面的工具。   [![近一周有更新][G]](https://github.com/vektra/mockery)   [![godoc][D]](https://godoc.org/github.com/vektra/mockery)
- [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) **star:6537** Mock SQL ，用于测试数据库交互   [![godoc][D]](https://godoc.org/github.com/DATA-DOG/go-sqlmock)
...
- [pgxmock](https://github.com/pashagolub/pgxmock) **star:572** A mock library implementing [pgx - PostgreSQL Driver and Toolkit](https://github.com/jackc/pgx/).   [![godoc][D]](https://godoc.org/github.com/pashagolub/pgxmock)
...
- [chromedp](https://github.com/knq/chromedp) **star:12875** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   [![近一周有更新][G]](https://github.com/knq/chromedp)   [![godoc][D]](https://godoc.org/github.com/knq/chromedp)
...
- [goldmark](https://github.com/yuin/goldmark) **star:4669** A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.   [![近一周有更新][G]](https://github.com/yuin/goldmark)   [![godoc][D]](https://godoc.org/github.com/yuin/goldmark)
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) **star:3510** 将HTML转换成Markdown   [![godoc][D]](https://godoc.org/github.com/JohannesKaufmann/html-to-markdown)
...
- [sh](https://github.com/mvdan/sh) **star:8597** Shell解析器和格式化工具。   [![近一周有更新][G]](https://github.com/mvdan/sh)   [![godoc][D]](https://godoc.org/github.com/mvdan/sh)
...
- [godump (goforj)](https://github.com/goforj/godump) **star:1728** Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.   [![godoc][D]](https://godoc.org/github.com/goforj/godump)
...
- [colly](https://github.com/asciimoo/colly) **star:25185** 快速和优雅的 Scraping 框架。   [![godoc][D]](https://godoc.org/github.com/asciimoo/colly)
...
- [github](https://github.com/google/go-github) **star:11170** 访问GitHub REST API v3的库。   [![近一周有更新][G]](https://github.com/google/go-github)   [![godoc][D]](https://godoc.org/github.com/google/go-github)
...
- [aws-sdk-go](https://github.com/aws/aws-sdk-go-v2) **star:3496** AWS 提供的官方go语言 SDK   [![近一周有更新][G]](https://github.com/aws/aws-sdk-go-v2)   [![godoc][D]](https://godoc.org/github.com/aws/aws-sdk-go-v2)
- [minio-go](https://github.com/minio/minio-go) **star:2917** 用于Amazon S3兼容云存储的Minio Go库。   [![近一周有更新][G]](https://github.com/minio/minio-go)   [![godoc][D]](https://godoc.org/github.com/minio/minio-go)
...
- [fzf](https://github.com/junegunn/fzf) **star:79020** 用Go编写的命令行模糊查找器。   [![近一周有更新][G]](https://github.com/junegunn/fzf)   [![godoc][D]](https://godoc.org/github.com/junegunn/fzf)
- [dive](https://github.com/wagoodman/dive) **star:53659** A tool for exploring each layer in a Docker image.   [![godoc][D]](https://godoc.org/github.com/wagoodman/dive)
...
- [ctop](https://github.com/bcicen/ctop) **star:17673** [Top-like](https://ctop.sh)接口(例如htop)用于容器度量。   [![godoc][D]](https://godoc.org/github.com/bcicen/ctop)
- [sqlx](https://github.com/jmoiron/sqlx) **star:17545** 为内建的数据库/sql 软件包提供一组扩展。   [![godoc][D]](https://godoc.org/github.com/jmoiron/sqlx)
- [goreleaser](https://github.com/goreleaser/goreleaser) **star:15679** 尽可能快速的发布 Go 语言二进制文件。   [![近一周有更新][G]](https://github.com/goreleaser/goreleaser)   [![godoc][D]](https://godoc.org/github.com/goreleaser/goreleaser)
...
- [peco](https://github.com/peco/peco) **star:7879** 简单的交互过滤工具。   [![近一周有更新][G]](https://github.com/peco/peco)   [![godoc][D]](https://godoc.org/github.com/peco/peco)
...
- [retry-go](https://github.com/avast/retry-go) **star:2904** Simple library for retry mechanism.   [![godoc][D]](https://godoc.org/github.com/avast/retry-go)
...
- [sesh](https://github.com/joshmedeski/sesh) **star:1845** Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.   [![近一周有更新][G]](https://github.com/joshmedeski/sesh)   [![godoc][D]](https://godoc.org/github.com/joshmedeski/sesh)
...
- [upterm](https://github.com/owenthereal/upterm) **star:1191** A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more.   [![godoc][D]](https://godoc.org/github.com/owenthereal/upterm)
...
- [limiters](https://github.com/mennanov/limiters) **star:626** Golang中的分布式应用程序速率限制器，具有可配置的后端和分布式锁。   [![近一周有更新][G]](https://github.com/mennanov/limiters)   [![godoc][D]](https://godoc.org/github.com/mennanov/limiters)
...
- [config-file-validator](https://github.com/Boeing/config-file-validator) **star:499** Cross Platform tool to validate configuration files.   [![近一周有更新][G]](https://github.com/Boeing/config-file-validator)   [![godoc][D]](https://godoc.org/github.com/Boeing/config-file-validator)
...
- [godoclive](https://github.com/syst3mctl/godoclive) **star:71** Generates interactive API documentation from Go HTTP handlers using static analysis of chi, gin, and net/http routers.   [![近一周有更新][G]](https://github.com/syst3mctl/godoclive)   [![godoc][D]](https://godoc.org/github.com/syst3mctl/godoclive)
...
- [uuid](https://github.com/google/uuid) **star:6019** 基于RFC 4122和DCE 1.1的uuid包:身份验证和安全服务。   [![godoc][D]](https://godoc.org/github.com/google/uuid)
...
- [validator](https://github.com/go-playground/validator) **star:19832**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   [![近一周有更新][G]](https://github.com/go-playground/validator)   [![godoc][D]](https://godoc.org/github.com/go-playground/validator)
...
- [go-git](https://github.com/go-git/go-git) **star:7279** 纯Go中高度可扩展的Git实现。   [![近一周有更新][G]](https://github.com/go-git/go-git)   [![godoc][D]](https://godoc.org/github.com/go-git/go-git)
...
- [Fiber](https://github.com/gofiber/fiber) **star:39473** 一个灵感来自Express.js的web框架构建在Fasthttp上。   [![近一周有更新][G]](https://github.com/gofiber/fiber)   [![godoc][D]](https://godoc.org/github.com/gofiber/fiber)
...
- [Echo](https://github.com/labstack/echo) **star:32253** 高性能、极简的Go web框架。   [![godoc][D]](https://godoc.org/github.com/labstack/echo)
- [GoFr](https://github.com/gofr-dev/gofr) **star:20909** Gofr is an opinionated microservice development framework.   [![近一周有更新][G]](https://github.com/gofr-dev/gofr)   [![godoc][D]](https://godoc.org/github.com/gofr-dev/gofr)
...
- [Hertz](https://github.com/cloudwego/hertz) **star:7139** A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.   [![godoc][D]](https://godoc.org/github.com/cloudwego/hertz)   [![包含中文文档][CN]](https://github.com/cloudwego/hertz)
...
- [goravel](https://github.com/goravel/goravel) **star:4475** A Laravel-inspired web framework with ORM, authentication, queue, task scheduling, and more built-in features.   [![近一周有更新][G]](https://github.com/goravel/goravel)   [![godoc][D]](https://godoc.org/github.com/goravel/goravel)   [![包含中文文档][CN]](https://github.com/goravel/goravel)
...
- [templui](https://github.com/axzilla/templui) **star:1500** Modern UI Components for Go & Templ.   [![近一周有更新][G]](https://github.com/axzilla/templui)
...
- [chi](https://github.com/go-chi/chi) **star:21872** 小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。   [![godoc][D]](https://godoc.org/github.com/go-chi/chi)
...
- [WebhookX](https://github.com/webhookx-io/webhookx) **star:292** A webhooks gateway for message receiving, processing, and reliable delivering.   [![近一周有更新][G]](https://github.com/webhookx-io/webhookx)   [![godoc][D]](https://godoc.org/github.com/webhookx-io/webhookx)
...
- [Dagu](https://github.com/dagu-go/dagu) **star:3212** No-code workflow executor. it executes DAGs defined in a simple YAML format.   [![近一周有更新][G]](https://github.com/dagu-go/dagu)   [![godoc][D]](https://godoc.org/github.com/dagu-go/dagu)
...
- [Cosign](https://github.com/sigstore/cosign) **star:5760** 在OCI注册中心中的容器签名、验证和存储。   [![近一周有更新][G]](https://github.com/sigstore/cosign)   [![godoc][D]](https://godoc.org/github.com/sigstore/cosign)
- [OpenZiti](https://github.com/openziti/ziti) **star:4035** A full, open source zero trust overlay network. Including numerous SDKs for numerous languages such as [golang](https://github.com/openziti/sdk-golang) allowing you to embed zero trust principles directly into your applications. The [OpenZiti Test Kitchen](https://github.com/openziti-test-kitchen) has numerous examples to draw inspiration from including a [zero trust ssh client - zssh](https://github.com/openziti-test-kitchen/zssh)   [![近一周有更新][G]](https://github.com/openziti/ziti)   [![godoc][D]](https://godoc.org/github.com/openziti/ziti)
- [Spire](https://github.com/spiffe/spire) **star:2270** SPIRE (SPIFFE Runtime Environment)是一个api工具链，用于跨各种托管平台在软件系统之间建立信任。   [![近一周有更新][G]](https://github.com/spiffe/spire)   [![godoc][D]](https://godoc.org/github.com/spiffe/spire)
...
- [vscode-go](https://github.com/golang/vscode-go) **star:4223** Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。   [![近一周有更新][G]](https://github.com/golang/vscode-go)
...
- [lensm](https://github.com/loov/lensm) **star:3674** Go assembly and source viewer.   [![godoc][D]](https://godoc.org/github.com/loov/lensm)
- [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) **star:2104** Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build.   [![近一周有更新][G]](https://github.com/Zxilly/go-size-analyzer)   [![godoc][D]](https://godoc.org/github.com/Zxilly/go-size-analyzer)   [![包含中文文档][CN]](https://github.com/Zxilly/go-size-analyzer)
...
- [kubernetes](https://github.com/kubernetes/kubernetes) **star:121375** 来自谷歌的容器集群管理器。   [![近一周有更新][G]](https://github.com/kubernetes/kubernetes)   [![godoc][D]](https://godoc.org/github.com/kubernetes/kubernetes)
- [Moby](https://github.com/moby/moby) **star:71567** Collaborative project for the container ecosystem to assemble container-based systems.   [![近一周有更新][G]](https://github.com/moby/moby)   [![godoc][D]](https://godoc.org/github.com/moby/moby)
- [traefik](https://github.com/containous/traefik) **star:62385** 反向代理和负载均衡器，支持多个后端。   [![近一周有更新][G]](https://github.com/containous/traefik)   [![godoc][D]](https://godoc.org/github.com/containous/traefik)
- [Gitea](https://github.com/go-gitea/gitea) **star:54513** 从 Gogs fork，完全由社区驱动。   [![近一周有更新][G]](https://github.com/go-gitea/gitea)   [![godoc][D]](https://godoc.org/github.com/go-gitea/gitea)   [![包含中文文档][CN]](https://github.com/go-gitea/gitea)
...
- [k9s](https://github.com/derailed/k9s) **star:33178** Kubernetes CLI to manage your clusters in style.   [![近一周有更新][G]](https://github.com/derailed/k9s)   [![godoc][D]](https://godoc.org/github.com/derailed/k9s)
- [k3s](https://github.com/k3s-io/k3s) **star:32583** Lightweight Kubernetes.   [![近一周有更新][G]](https://github.com/k3s-io/k3s)   [![godoc][D]](https://godoc.org/github.com/k3s-io/k3s)
- [minikube](https://github.com/kubernetes/minikube) **star:31629** Run Kubernetes locally.   [![近一周有更新][G]](https://github.com/kubernetes/minikube)   [![godoc][D]](https://godoc.org/github.com/kubernetes/minikube)
- [k6](https://github.com/grafana/k6) **star:30222** A modern load testing tool, using Go and JavaScript.   [![近一周有更新][G]](https://github.com/grafana/k6)   [![godoc][D]](https://godoc.org/github.com/grafana/k6)
- [colima](https://github.com/abiosoft/colima) **star:27816** Container runtimes on macOS (and Linux) with minimal setup.   [![近一周有更新][G]](https://github.com/abiosoft/colima)   [![godoc][D]](https://godoc.org/github.com/abiosoft/colima)
- [Vegeta](https://github.com/tsenart/vegeta) **star:24963** HTTP负载测试工具和库。超过9000 !   [![godoc][D]](https://godoc.org/github.com/tsenart/vegeta)
- [Hey](https://github.com/rakyll/hey) **star:19864** 压力测试工具，可用来代替 ApacheBench (ab)。   [![godoc][D]](https://godoc.org/github.com/rakyll/hey)
- [chaosmonkey](https://github.com/Netflix/chaosmonkey) **star:16715** A resiliency tool that helps applications tolerate random instance failures.   [![godoc][D]](https://godoc.org/github.com/Netflix/chaosmonkey)
...
- [kubeshark](https://github.com/kubeshark/kubeshark) **star:11836** API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.   [![近一周有更新][G]](https://github.com/kubeshark/kubeshark)   [![godoc][D]](https://godoc.org/github.com/kubeshark/kubeshark)
...
- [Fleet device management](https://github.com/fleetdm/fleet) **star:6179** Lightweight, programmable telemetry for servers and workstations.   [![近一周有更新][G]](https://github.com/fleetdm/fleet)   [![godoc][D]](https://godoc.org/github.com/fleetdm/fleet)
...
- [k0s](https://github.com/k0sproject/k0s) **star:5829** Zero Friction Kubernetes distribution.   [![近一周有更新][G]](https://github.com/k0sproject/k0s)   [![godoc][D]](https://godoc.org/github.com/k0sproject/k0s)
...
- [Pomerium](https://github.com/pomerium/pomerium) **star:4725** Pomerium是一个可识别身份的访问代理。   [![近一周有更新][G]](https://github.com/pomerium/pomerium)   [![godoc][D]](https://godoc.org/github.com/pomerium/pomerium)
...
- [s5cmd](https://github.com/peak/s5cmd) **star:3976** 非常快的S3和本地文件系统执行工具。   [![godoc][D]](https://godoc.org/github.com/peak/s5cmd)
- [docker-volume-backup](https://github.com/offen/docker-volume-backup) **star:3458** Backup Docker volumes locally or to any S3, WebDAV, Azure Blob Storage, Dropbox or SSH compatible storage.   [![近一周有更新][G]](https://github.com/offen/docker-volume-backup)   [![godoc][D]](https://godoc.org/github.com/offen/docker-volume-backup)
...
- [croc](https://github.com/schollz/croc) **star:34481** 轻松、安全地将文件或文件夹从一台计算机发送到另一台计算机。   [![近一周有更新][G]](https://github.com/schollz/croc)   [![godoc][D]](https://godoc.org/github.com/schollz/croc)
- [restic](https://github.com/restic/restic) **star:32847** 消除重复项备份程序。   [![godoc][D]](https://godoc.org/github.com/restic/restic)
- [Gor](https://github.com/buger/gor) **star:19272** Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。   [![godoc][D]](https://godoc.org/github.com/buger/gor)
- [JuiceFS](https://github.com/juicedata/juicefs) **star:13360** Distributed POSIX file system built on top of Redis and AWS S3.   [![近一周有更新][G]](https://github.com/juicedata/juicefs)   [![godoc][D]](https://godoc.org/github.com/juicedata/juicefs)
...
- [blocky](https://github.com/0xERR0R/blocky) **star:6213** 快速和轻量级的DNS代理作为广告拦截器，为本地网络具有许多功能。   [![近一周有更新][G]](https://github.com/0xERR0R/blocky)   [![godoc][D]](https://godoc.org/github.com/0xERR0R/blocky)
- [Backrest](https://github.com/garethgeorge/backrest) **star:5851** Web-based UI and orchestrator for restic backup.   [![godoc][D]](https://godoc.org/github.com/garethgeorge/backrest)
...
- [Duplicacy](https://github.com/gilbertchen/duplicacy) **star:5638** 跨平台网络和云备份工具。   [![godoc][D]](https://godoc.org/github.com/gilbertchen/duplicacy)
...
- [onWatch](https://github.com/onllm-dev/onWatch) **star:456** Monitor AI API quotas across providers locally with historical tracking, alerts, and a web dashboard to avoid surprise throttling and budget overruns.   [![近一周有更新][G]](https://github.com/onllm-dev/onWatch)   [![godoc][D]](https://godoc.org/github.com/onllm-dev/onWatch)
...
- [GoBooks](https://github.com/dariubs/GoBooks) **star:19268** 一份精选的 Go 书籍清单。   [![godoc][D]](https://godoc.org/github.com/dariubs/GoBooks)
...
- [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) **star:44263** Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
...
- [go-patterns](https://github.com/tmrts/go-patterns) **star:27830** 策划的清单去设计模式，食谱和习惯用法。   [![godoc][D]](https://godoc.org/github.com/tmrts/go-patterns)
- [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) **star:23553** 学习使用测试驱动开发。   [![近一周有更新][G]](https://github.com/quii/learn-go-with-tests)   [![godoc][D]](https://godoc.org/github.com/quii/learn-go-with-tests)   [![包含中文文档][CN]](https://github.com/quii/learn-go-with-tests)
...
- [Learn Go with 1000+ Exercises](https://github.com/inancgumus/learngo) **star:19899** 通过成千上万的例子、练习和测验来学习Go。   [![godoc][D]](https://godoc.org/github.com/inancgumus/learngo)
- [go-clean-template](https://github.com/evrone/go-clean-template) **star:7521** Golang服务的Clean Architecture模板。   [![近一周有更新][G]](https://github.com/evrone/go-clean-template)   [![godoc][D]](https://godoc.org/github.com/evrone/go-clean-template)
