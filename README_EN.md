...
**This project is [awesome-go](https://awesome-go.com/) Chinese version, last sync time : 2026-07-16 08:08:23(Synchronize every day)**
...
- [Ollama](https://github.com/jmorganca/ollama) **star:176198** Run large language models locally.   [![There was an update last month][G]](https://github.com/jmorganca/ollama)   [![godoc][D]](https://godoc.org/github.com/jmorganca/ollama)
- [LocalAI](https://github.com/mudler/LocalAI) **star:47552** Open Source OpenAI alternative, self-host AI models.   [![There was an update last month][G]](https://github.com/mudler/LocalAI)   [![godoc][D]](https://godoc.org/github.com/mudler/LocalAI)
...
- [mcp-go](https://github.com/mark3labs/mcp-go) **star:8895** Go implementation of the Model Context Protocol for building MCP servers and clients in Go.   [![There was an update last month][G]](https://github.com/mark3labs/mcp-go)   [![godoc][D]](https://godoc.org/github.com/mark3labs/mcp-go)
- [trpc-agent-go](https://github.com/trpc-group/trpc-agent-go) **star:1546** Framework for building LLM-based multi-agent systems.   [![There was an update last month][G]](https://github.com/trpc-group/trpc-agent-go)   [![godoc][D]](https://godoc.org/github.com/trpc-group/trpc-agent-go)   [![Contains Chinese documents][CN]](https://github.com/trpc-group/trpc-agent-go)
...
- [spicedb](https://github.com/authzed/spicedb) **star:6865** A Zanzibar-inspired database that enables fine-grained authorization.   [![There was an update last month][G]](https://github.com/authzed/spicedb)   [![godoc][D]](https://godoc.org/github.com/authzed/spicedb)   [![Contains Chinese documents][CN]](https://github.com/authzed/spicedb)
...
- [go-ethereum](https://github.com/ethereum/go-ethereum) **star:51356** Official Go implementation of the Ethereum protocol.   [![There was an update last month][G]](https://github.com/ethereum/go-ethereum)   [![godoc][D]](https://godoc.org/github.com/ethereum/go-ethereum)
...
- [air](https://github.com/cosmtrek/air) **star:23786** Air - Live reload for Go apps.   [![There was an update last month][G]](https://github.com/cosmtrek/air)   [![godoc][D]](https://godoc.org/github.com/cosmtrek/air)   [![Contains Chinese documents][CN]](https://github.com/cosmtrek/air)
- [Task](https://github.com/go-task/task) **star:15845** simple "Make" alternative.   [![There was an update last month][G]](https://github.com/go-task/task)   [![godoc][D]](https://godoc.org/github.com/go-task/task)
...
- [goyek](https://github.com/goyek/goyek) **star:693** Create build pipelines in Go.   [![godoc][D]](https://godoc.org/github.com/goyek/goyek)
...
- [bubbletea](https://github.com/charmbracelet/bubbletea) **star:43757** Go framework to build terminal apps, based on The Elm Architecture.   [![There was an update last month][G]](https://github.com/charmbracelet/bubbletea)   [![godoc][D]](https://godoc.org/github.com/charmbracelet/bubbletea)
...
- [lipgloss](https://github.com/charmbracelet/lipgloss) **star:11570** Declaratively define styles for color, format and layout in the terminal.   [![There was an update last month][G]](https://github.com/charmbracelet/lipgloss)   [![godoc][D]](https://godoc.org/github.com/charmbracelet/lipgloss)
...
- [bubbles](https://github.com/charmbracelet/bubbles) **star:8666** TUI components for bubbletea.   [![There was an update last month][G]](https://github.com/charmbracelet/bubbles)   [![godoc][D]](https://godoc.org/github.com/charmbracelet/bubbles)
- [pterm](https://github.com/pterm/pterm) **star:5500** A library to beautify console output on every platform with many combinable components.   [![There was an update last month][G]](https://github.com/pterm/pterm)   [![godoc][D]](https://godoc.org/github.com/pterm/pterm)
...
- [asciigraph](https://github.com/guptarohit/asciigraph) **star:3072** Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.   [![godoc][D]](https://godoc.org/github.com/guptarohit/asciigraph)
...
- [cobra](https://github.com/spf13/cobra) **star:44274** Commander for modern Go CLI interactions.   [![There was an update last month][G]](https://github.com/spf13/cobra)   [![godoc][D]](https://godoc.org/github.com/spf13/cobra)
- [carapace-bin](https://github.com/rsteube/carapace-bin) **star:1892** Multi-shell multi-command argument completer.   [![There was an update last month][G]](https://github.com/rsteube/carapace-bin)   [![godoc][D]](https://godoc.org/github.com/rsteube/carapace-bin)
- [carapace](https://github.com/rsteube/carapace) **star:1369** Command argument completion generator for spf13/cobra.   [![There was an update last month][G]](https://github.com/rsteube/carapace)   [![godoc][D]](https://godoc.org/github.com/rsteube/carapace)
- [complete](https://github.com/posener/complete) **star:957** Write bash completions in Go + Go command bash completion.   [![godoc][D]](https://godoc.org/github.com/posener/complete)
...
- [viper](https://github.com/spf13/viper) **star:30474** Go configuration with fangs.   [![godoc][D]](https://godoc.org/github.com/spf13/viper)
- [godotenv](https://github.com/joho/godotenv) **star:10537** Go port of Ruby's dotenv library (Loads environment variables from `.env`).   [![godoc][D]](https://godoc.org/github.com/joho/godotenv)
- [sonic](https://github.com/bytedance/sonic) **star:9540** A blazingly fast JSON serializing & deserializing library.   [![godoc][D]](https://godoc.org/github.com/bytedance/sonic)   [![Contains Chinese documents][CN]](https://github.com/bytedance/sonic)
- [env](https://github.com/caarlos0/env) **star:6262** Parse environment variables to Go structs (with defaults).   [![godoc][D]](https://godoc.org/github.com/caarlos0/env)
...
- [koanf](https://github.com/knadh/koanf) **star:4116** Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.   [![There was an update last month][G]](https://github.com/knadh/koanf)   [![godoc][D]](https://godoc.org/github.com/knadh/koanf)
...
- [drone](https://github.com/drone/drone) **star:37324** Drone is a Continuous Integration platform built on Docker, written in Go.   [![There was an update last month][G]](https://github.com/drone/drone)   [![godoc][D]](https://godoc.org/github.com/drone/drone)
- [woodpecker](https://github.com/woodpecker-ci/woodpecker) **star:7442** Woodpecker is a community fork of the Drone CI system.   [![There was an update last month][G]](https://github.com/woodpecker-ci/woodpecker)   [![godoc][D]](https://godoc.org/github.com/woodpecker-ci/woodpecker)
...
- [roaring](https://github.com/RoaringBitmap/roaring) **star:2915** Go package implementing compressed bitsets.   [![There was an update last month][G]](https://github.com/RoaringBitmap/roaring)   [![godoc][D]](https://godoc.org/github.com/RoaringBitmap/roaring)
...
- [gods](https://github.com/emirpasic/gods) **star:17446** Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.   [![godoc][D]](https://godoc.org/github.com/emirpasic/gods)
...
- [hatchet](https://github.com/hatchet-dev/hatchet) **star:7510** Distributed, Fault-tolerant task queue.   [![There was an update last month][G]](https://github.com/hatchet-dev/hatchet)   [![godoc][D]](https://godoc.org/github.com/hatchet-dev/hatchet)
...
- [bleve](https://github.com/blevesearch/bleve) **star:11150** Modern text indexing library for go.   [![There was an update last month][G]](https://github.com/blevesearch/bleve)   [![godoc][D]](https://godoc.org/github.com/blevesearch/bleve)
...
- [dolt](https://github.com/dolthub/dolt) **star:23869** Dolt – It's Git for Data.   [![There was an update last month][G]](https://github.com/dolthub/dolt)   [![godoc][D]](https://godoc.org/github.com/dolthub/dolt)
...
- [badger](https://github.com/dgraph-io/badger) **star:15714** Fast key-value store in Go.   [![There was an update last month][G]](https://github.com/dgraph-io/badger)   [![godoc][D]](https://godoc.org/github.com/dgraph-io/badger)
...
- [bbolt](https://github.com/etcd-io/bbolt) **star:9633** An embedded key/value database for Go.   [![There was an update last month][G]](https://github.com/etcd-io/bbolt)   [![godoc][D]](https://godoc.org/github.com/etcd-io/bbolt)
...
- [prometheus](https://github.com/prometheus/prometheus) **star:65234** Monitoring system and time series database.   [![There was an update last month][G]](https://github.com/prometheus/prometheus)   [![godoc][D]](https://godoc.org/github.com/prometheus/prometheus)
- [Milvus](https://github.com/milvus-io/milvus) **star:45239** Milvus is a vector database for embedding management, analytics and search.   [![There was an update last month][G]](https://github.com/milvus-io/milvus)   [![godoc][D]](https://godoc.org/github.com/milvus-io/milvus)
...
- [rqlite](https://github.com/rqlite/rqlite) **star:17628** The lightweight, distributed, relational database built on SQLite.   [![There was an update last month][G]](https://github.com/rqlite/rqlite)   [![godoc][D]](https://godoc.org/github.com/rqlite/rqlite)
- [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) **star:17339** fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.   [![There was an update last month][G]](https://github.com/VictoriaMetrics/VictoriaMetrics)   [![godoc][D]](https://godoc.org/github.com/VictoriaMetrics/VictoriaMetrics)
...
- [pebble](https://github.com/cockroachdb/pebble) **star:5958** RocksDB/LevelDB inspired key-value database in Go.   [![There was an update last month][G]](https://github.com/cockroachdb/pebble)   [![godoc][D]](https://godoc.org/github.com/cockroachdb/pebble)
...
- [migrate](https://github.com/golang-migrate/migrate) **star:18712** Database migrations. CLI and Golang library.   [![godoc][D]](https://godoc.org/github.com/golang-migrate/migrate)
- [bytebase](https://github.com/bytebase/bytebase) **star:14263** Safe database schema change and version control for DevOps teams.   [![There was an update last month][G]](https://github.com/bytebase/bytebase)   [![godoc][D]](https://godoc.org/github.com/bytebase/bytebase)
- [goose](https://github.com/pressly/goose) **star:11172** Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.   [![There was an update last month][G]](https://github.com/pressly/goose)   [![godoc][D]](https://godoc.org/github.com/pressly/goose)
- [atlas](https://github.com/ariga/atlas) **star:8580** A Database Toolkit. A CLI designed to help companies better work with their data.   [![godoc][D]](https://godoc.org/github.com/ariga/atlas)
- [dbmate](https://github.com/amacneil/dbmate) **star:6997** A lightweight, framework-agnostic database migration tool.   [![There was an update last month][G]](https://github.com/amacneil/dbmate)   [![godoc][D]](https://godoc.org/github.com/amacneil/dbmate)
...
- [vitess](https://github.com/youtube/vitess) **star:21142** vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.   [![There was an update last month][G]](https://github.com/youtube/vitess)   [![godoc][D]](https://godoc.org/github.com/youtube/vitess)
- [pgweb](https://github.com/sosedoff/pgweb) **star:9434** Web-based PostgreSQL database browser.   [![There was an update last month][G]](https://github.com/sosedoff/pgweb)   [![godoc][D]](https://godoc.org/github.com/sosedoff/pgweb)
...
- [pREST](https://github.com/prest/prest) **star:4593** Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.   [![There was an update last month][G]](https://github.com/prest/prest)   [![godoc][D]](https://godoc.org/github.com/prest/prest)
...
- [sqlc](https://github.com/kyleconroy/sqlc) **star:18011** Generate type-safe code from SQL.   [![There was an update last month][G]](https://github.com/kyleconroy/sqlc)   [![godoc][D]](https://godoc.org/github.com/kyleconroy/sqlc)
...
- [pgx](https://github.com/jackc/pgx) **star:14042** PostgreSQL driver supporting features beyond those exposed by database/sql.   [![There was an update last month][G]](https://github.com/jackc/pgx)   [![godoc][D]](https://godoc.org/github.com/jackc/pgx)
...
- [redis](https://github.com/redis/go-redis) **star:22191** Redis client for Golang.   [![There was an update last month][G]](https://github.com/redis/go-redis)   [![godoc][D]](https://godoc.org/github.com/redis/go-redis)   [![Contains Chinese documents][CN]](https://github.com/redis/go-redis)
...
- [NATS](https://github.com/nats-io/nats-server) **star:20217** NATS is a simple, secure, and performant communications system for digital systems, services, and devices.   [![There was an update last month][G]](https://github.com/nats-io/nats-server)   [![godoc][D]](https://godoc.org/github.com/nats-io/nats-server)
...
- [lura](https://github.com/luraproject/lura) **star:6792** Ultra performant API Gateway framework with middlewares.   [![There was an update last month][G]](https://github.com/luraproject/lura)   [![godoc][D]](https://godoc.org/github.com/luraproject/lura)
...
- [dragonboat](https://github.com/lni/dragonboat) **star:5318** A feature complete and high performance multi-group Raft library in Go.   [![godoc][D]](https://godoc.org/github.com/lni/dragonboat)   [![Contains Chinese documents][CN]](https://github.com/lni/dragonboat)
...
- [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) **star:3257** Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.   [![There was an update last month][G]](https://github.com/dragonflyoss/Dragonfly2)   [![godoc][D]](https://godoc.org/github.com/dragonflyoss/Dragonfly2)
...
- [oras](https://github.com/oras-project/oras) **star:2351** CLI and library for OCI Artifacts in container registries.   [![There was an update last month][G]](https://github.com/oras-project/oras)   [![godoc][D]](https://godoc.org/github.com/oras-project/oras)
...
- [raft](https://github.com/etcd-io/raft) **star:1073** Go implementation of the Raft consensus protocol, by CoreOS.   [![There was an update last month][G]](https://github.com/etcd-io/raft)   [![godoc][D]](https://godoc.org/github.com/etcd-io/raft)
...
- [Mailpit](https://github.com/axllent/mailpit) **star:9876** Email and SMTP testing tool for developers.   [![There was an update last month][G]](https://github.com/axllent/mailpit)   [![godoc][D]](https://godoc.org/github.com/axllent/mailpit)
...
- [go-mail](https://github.com/wneessen/go-mail) **star:1446** A simple Go library for sending mails in Go.   [![There was an update last month][G]](https://github.com/wneessen/go-mail)   [![godoc][D]](https://godoc.org/github.com/wneessen/go-mail)
...
- [FrankenPHP](https://github.com/dunglas/frankenphp) **star:11218** PHP embedded in Go, with a `net/http` handler.   [![There was an update last month][G]](https://github.com/dunglas/frankenphp)   [![godoc][D]](https://godoc.org/github.com/dunglas/frankenphp)
- [expr](https://github.com/antonmedv/expr) **star:7945** Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.   [![godoc][D]](https://godoc.org/github.com/antonmedv/expr)
- [goja](https://github.com/dop251/goja) **star:6997** ECMAScript 5.1(+) implementation in Go.   [![godoc][D]](https://godoc.org/github.com/dop251/goja)
...
- [cel-go](https://github.com/google/cel-go) **star:3031** Fast, portable, non-Turing complete expression evaluation with gradual typing.   [![There was an update last month][G]](https://github.com/google/cel-go)   [![godoc][D]](https://godoc.org/github.com/google/cel-go)
- [starlark-go](https://github.com/google/starlark-go) **star:2734** Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.   [![There was an update last month][G]](https://github.com/google/starlark-go)   [![godoc][D]](https://godoc.org/github.com/google/starlark-go)
...
- [gdu](https://github.com/dundee/gdu) **star:5815** Disk usage analyzer with console interface.   [![godoc][D]](https://godoc.org/github.com/dundee/gdu)
...
- [decimal](https://github.com/shopspring/decimal) **star:7446** Arbitrary-precision fixed-point decimal numbers.   [![godoc][D]](https://godoc.org/github.com/shopspring/decimal)
- [ticker](https://github.com/achannarasappa/ticker) **star:6146** Terminal stock watcher and stock position tracker.   [![godoc][D]](https://godoc.org/github.com/achannarasappa/ticker)
...
- [raylib-go](https://github.com/gen2brain/raylib-go) **star:2485** Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [Tile38](https://github.com/tidwall/tile38) **star:9690** Geolocation DB with spatial index and realtime geofencing.   [![There was an update last month][G]](https://github.com/tidwall/tile38)   [![godoc][D]](https://godoc.org/github.com/tidwall/tile38)
...
- [fyne](https://github.com/fyne-io/fyne) **star:28477** Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.   [![There was an update last month][G]](https://github.com/fyne-io/fyne)   [![godoc][D]](https://godoc.org/github.com/fyne-io/fyne)
...
- [webview](https://github.com/zserge/webview) **star:14158** Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [proton](https://github.com/CzaxStudio/proton) **star:31** Pure Go immediate-mode GUI framework built on Gio with zero Cgo dependencies.   [![There was an update last month][G]](https://github.com/CzaxStudio/proton)   [![godoc][D]](https://godoc.org/github.com/CzaxStudio/proton)
...
- [imaginary](https://github.com/h2non/imaginary) **star:6071** Fast and simple HTTP microservice for image resizing.   [![godoc][D]](https://godoc.org/github.com/h2non/imaginary)
- [imaging](https://github.com/disintegration/imaging) **star:5739** Simple Go image processing package.   [![godoc][D]](https://godoc.org/github.com/disintegration/imaging)
- [gg](https://github.com/fogleman/gg) **star:4787** 2D rendering in pure Go.   [![godoc][D]](https://godoc.org/github.com/fogleman/gg)
...
- [gocron](https://github.com/go-co-op/gocron) **star:7103** Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).   [![There was an update last month][G]](https://github.com/go-co-op/gocron)   [![godoc][D]](https://godoc.org/github.com/go-co-op/gocron)
...
- [GJSON](https://github.com/tidwall/gjson) **star:15544** Get a JSON value with one line of code.   [![godoc][D]](https://godoc.org/github.com/tidwall/gjson)
...
- [zerolog](https://github.com/rs/zerolog) **star:12467** Zero-allocation JSON logger.   [![godoc][D]](https://godoc.org/github.com/rs/zerolog)
...
- [GoMLX](https://github.com/gomlx/gomlx) **star:1482** An accelerated Machine Learning framework for Go.   [![There was an update last month][G]](https://github.com/gomlx/gomlx)   [![godoc][D]](https://godoc.org/github.com/gomlx/gomlx)
...
- [Asynq](https://github.com/hibiken/asynq) **star:13521** A simple, reliable, and efficient distributed task queue for Go built on top of Redis.   [![godoc][D]](https://godoc.org/github.com/hibiken/asynq)
- [Centrifugo](https://github.com/centrifugal/centrifugo) **star:10515** Real-time messaging (Websockets or SockJS) server in Go.   [![There was an update last month][G]](https://github.com/centrifugal/centrifugo)   [![godoc][D]](https://godoc.org/github.com/centrifugal/centrifugo)
...
- [go-eventbus](https://github.com/stanipetrosyan/go-eventbus) **star:11** Simple Event Bus package for Go.   [![godoc][D]](https://godoc.org/github.com/stanipetrosyan/go-eventbus)
  messaging system.
- [sarama](https://github.com/Shopify/sarama) **star:12504** Go library for Apache Kafka.   [![There was an update last month][G]](https://github.com/Shopify/sarama)   [![godoc][D]](https://godoc.org/github.com/Shopify/sarama)
...
- [unioffice](https://github.com/unidoc/unioffice) **star:4894** Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.   [![godoc][D]](https://godoc.org/github.com/unidoc/unioffice)

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize](https://github.com/xuri/excelize) **star:20784** Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.   [![There was an update last month][G]](https://github.com/xuri/excelize)   [![godoc][D]](https://godoc.org/github.com/xuri/excelize)
...
- [fx](https://github.com/uber-go/fx) **star:7601** A dependency injection based application framework for Go (built on top of dig).   [![godoc][D]](https://godoc.org/github.com/uber-go/fx)
...
- [gatus](https://github.com/TwinProduction/gatus) **star:11518** Automated service health dashboard.   [![There was an update last month][G]](https://github.com/TwinProduction/gatus)   [![godoc][D]](https://godoc.org/github.com/TwinProduction/gatus)
...
- [purego](https://github.com/ebitengine/purego) **star:3726** A library for calling C functions from Go without Cgo.   [![There was an update last month][G]](https://github.com/ebitengine/purego)
...
- [go-pinyin](https://github.com/mozillazg/go-pinyin) **star:1785** CN Hanzi to Hanyu Pinyin converter.   [![godoc][D]](https://godoc.org/github.com/mozillazg/go-pinyin)
...
- [webrtc](https://github.com/pions/webrtc) **star:16637** A pure Go implementation of the WebRTC API.   [![There was an update last month][G]](https://github.com/pions/webrtc)   [![godoc][D]](https://godoc.org/github.com/pions/webrtc)
- [cloudflared](https://github.com/cloudflare/cloudflared) **star:14867** Cloudflare Tunnel client (formerly Argo Tunnel).   [![There was an update last month][G]](https://github.com/cloudflare/cloudflared)   [![godoc][D]](https://godoc.org/github.com/cloudflare/cloudflared)
- [quic-go](https://github.com/lucas-clemente/quic-go) **star:11699** An implementation of the QUIC protocol in pure Go.   [![There was an update last month][G]](https://github.com/lucas-clemente/quic-go)   [![godoc][D]](https://godoc.org/github.com/lucas-clemente/quic-go)
- [gnet](https://github.com/panjf2000/gnet) **star:11211** `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.   [![There was an update last month][G]](https://github.com/panjf2000/gnet)   [![godoc][D]](https://godoc.org/github.com/panjf2000/gnet)   [![Contains Chinese documents][CN]](https://github.com/panjf2000/gnet)
...
- [tun2socks](https://github.com/xjasonlyu/tun2socks) **star:5400** A pure go implementation of tun2socks powered by [gVisor](https://gvisor.dev/) TCP/IP stack.   [![There was an update last month][G]](https://github.com/xjasonlyu/tun2socks)   [![godoc][D]](https://godoc.org/github.com/xjasonlyu/tun2socks)
...
- [kcp-go](https://github.com/xtaci/kcp-go) **star:4530** KCP - Fast and Reliable ARQ Protocol.   [![godoc][D]](https://godoc.org/github.com/xtaci/kcp-go)
...
- [ftpserverlib](https://github.com/fclairamb/ftpserverlib) **star:472** Fully featured FTP server library.   [![godoc][D]](https://godoc.org/github.com/fclairamb/ftpserverlib)
...
- [bart](https://github.com/gaissmai/bart) **star:149** Package bart provides a Balanced-Routing-Table (BART) for very fast IP to CIDR lookups and more.   [![There was an update last month][G]](https://github.com/gaissmai/bart)   [![godoc][D]](https://godoc.org/github.com/gaissmai/bart)
...
- [resty](https://github.com/go-resty/resty) **star:11725** Simple HTTP and REST client for Go inspired by Ruby rest-client.   [![There was an update last month][G]](https://github.com/go-resty/resty)   [![godoc][D]](https://godoc.org/github.com/go-resty/resty)
- [req](https://github.com/imroc/req) **star:4821** Simple Go HTTP client with Black Magic (Less code and More efficiency).   [![There was an update last month][G]](https://github.com/imroc/req)   [![godoc][D]](https://godoc.org/github.com/imroc/req)
...
- [syft](https://github.com/anchore/syft) **star:9241** A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.   [![There was an update last month][G]](https://github.com/anchore/syft)   [![godoc][D]](https://godoc.org/github.com/anchore/syft)
...
- [jaeger](https://github.com/jaegertracing/jaeger) **star:22999** A distributed tracing system.   [![There was an update last month][G]](https://github.com/jaegertracing/jaeger)   [![godoc][D]](https://godoc.org/github.com/jaegertracing/jaeger)
...
- [age](https://github.com/FiloSottile/age) **star:22877** A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.   [![godoc][D]](https://godoc.org/github.com/FiloSottile/age)
- [lego](https://github.com/go-acme/lego) **star:9736** Pure Go ACME client library and CLI tool (for use with Let's Encrypt).   [![There was an update last month][G]](https://github.com/go-acme/lego)   [![godoc][D]](https://godoc.org/github.com/go-acme/lego)
- [CertMagic](https://github.com/caddyserver/certmagic) **star:5582** Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal.   [![There was an update last month][G]](https://github.com/caddyserver/certmagic)   [![godoc][D]](https://godoc.org/github.com/caddyserver/certmagic)
...
- [memguard](https://github.com/awnumar/memguard) **star:2749** A pure Go library for handling sensitive values in memory.   [![godoc][D]](https://godoc.org/github.com/awnumar/memguard)
...
- [beelzebub](https://github.com/mariocandela/beelzebub) **star:2090** A secure low code honeypot framework, leveraging AI for System Virtualization.   [![There was an update last month][G]](https://github.com/mariocandela/beelzebub)   [![godoc][D]](https://godoc.org/github.com/mariocandela/beelzebub)
...
- [Caddy](https://github.com/caddyserver/caddy) **star:74054** Caddy is an alternative, HTTP/2 web server that's easy to configure and use.   [![There was an update last month][G]](https://github.com/caddyserver/caddy)   [![godoc][D]](https://godoc.org/github.com/caddyserver/caddy)
...
- [etcd](https://github.com/etcd-io/etcd) **star:51992** Highly-available key value store for shared configuration and service discovery.   [![There was an update last month][G]](https://github.com/etcd-io/etcd)   [![godoc][D]](https://godoc.org/github.com/etcd-io/etcd)
- [SFTPGo](https://github.com/drakkan/sftpgo) **star:12281** Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage.   [![There was an update last month][G]](https://github.com/drakkan/sftpgo)   [![godoc][D]](https://godoc.org/github.com/drakkan/sftpgo)
- [RoadRunner](https://github.com/spiral/roadrunner) **star:8489** High-performance PHP application server, load-balancer and process manager.   [![There was an update last month][G]](https://github.com/spiral/roadrunner)   [![godoc][D]](https://godoc.org/github.com/spiral/roadrunner)
...
- [Wish](https://github.com/charmbracelet/wish) **star:5332** Make SSH apps, just like that!   [![There was an update last month][G]](https://github.com/charmbracelet/wish)   [![godoc][D]](https://godoc.org/github.com/charmbracelet/wish)
...
- [Fider](https://github.com/getfider/fider) **star:4417** Fider is an open platform to collect and organize customer feedback.   [![There was an update last month][G]](https://github.com/getfider/fider)   [![godoc][D]](https://godoc.org/github.com/getfider/fider)
...
- [minio](https://github.com/pgsty/minio) **star:1837** Community Maintained Fork of minio (Object Storage Service).   [![godoc][D]](https://godoc.org/github.com/pgsty/minio)   [![Contains Chinese documents][CN]](https://github.com/pgsty/minio)
...
- [templ](https://github.com/a-h/templ) **star:10410** A HTML templating language that has great developer tooling.   [![There was an update last month][G]](https://github.com/a-h/templ)   [![godoc][D]](https://godoc.org/github.com/a-h/templ)
...
- [maroto](https://github.com/johnfercher/maroto) **star:2738** A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.   [![There was an update last month][G]](https://github.com/johnfercher/maroto)   [![godoc][D]](https://godoc.org/github.com/johnfercher/maroto)
...
- [Testify](https://github.com/stretchr/testify) **star:26180** Sacred extension to the standard go testing package.   [![There was an update last month][G]](https://github.com/stretchr/testify)   [![godoc][D]](https://godoc.org/github.com/stretchr/testify)
- [keploy](https://github.com/keploy/keploy) **star:18151** Generate Testcase and Data Mocks from API calls automatically.   [![There was an update last month][G]](https://github.com/keploy/keploy)   [![godoc][D]](https://godoc.org/github.com/keploy/keploy)
...
- [hoverfly](https://github.com/SpectoLabs/hoverfly) **star:2504** HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI.   [![There was an update last month][G]](https://github.com/SpectoLabs/hoverfly)   [![godoc][D]](https://godoc.org/github.com/SpectoLabs/hoverfly)
...
- [chromedp](https://github.com/knq/chromedp) **star:13182** a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.   [![There was an update last month][G]](https://github.com/knq/chromedp)   [![godoc][D]](https://godoc.org/github.com/knq/chromedp)
...
- [playwright-go](https://github.com/mxschmitt/playwright-go) **star:3421** browser automation library to control Chromium, Firefox and WebKit with a single API.   [![godoc][D]](https://godoc.org/github.com/mxschmitt/playwright-go)
...
- [goldmark](https://github.com/yuin/goldmark) **star:4903** A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.   [![There was an update last month][G]](https://github.com/yuin/goldmark)   [![godoc][D]](https://godoc.org/github.com/yuin/goldmark)
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) **star:3738** Convert HTML to Markdown. Even works with entire websites and can be extended through rules.   [![There was an update last month][G]](https://github.com/JohannesKaufmann/html-to-markdown)   [![godoc][D]](https://godoc.org/github.com/JohannesKaufmann/html-to-markdown)
...
- [sh](https://github.com/mvdan/sh) **star:8901** Shell parser and formatter.   [![godoc][D]](https://godoc.org/github.com/mvdan/sh)
...
- [GoQuery](https://github.com/PuerkitoBio/goquery) **star:14973** GoQuery brings a syntax and a set of features similar to jQuery to the Go language.   [![There was an update last month][G]](https://github.com/PuerkitoBio/goquery)   [![godoc][D]](https://godoc.org/github.com/PuerkitoBio/goquery)
...
- [github](https://github.com/google/go-github) **star:11270** Go library for accessing the GitHub REST API v3.   [![There was an update last month][G]](https://github.com/google/go-github)   [![godoc][D]](https://godoc.org/github.com/google/go-github)
...
- [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) **star:4475** Google Cloud APIs Go Client Library.   [![There was an update last month][G]](https://github.com/GoogleCloudPlatform/gcloud-golang)   [![godoc][D]](https://godoc.org/github.com/GoogleCloudPlatform/gcloud-golang)
...
- [fzf](https://github.com/junegunn/fzf) **star:81753** Command-line fuzzy finder written in Go.   [![There was an update last month][G]](https://github.com/junegunn/fzf)   [![godoc][D]](https://godoc.org/github.com/junegunn/fzf)
...
- [lo](https://github.com/samber/lo) **star:21383** A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)   [![There was an update last month][G]](https://github.com/samber/lo)   [![godoc][D]](https://godoc.org/github.com/samber/lo)
...
- [goreleaser](https://github.com/goreleaser/goreleaser) **star:15936** Deliver Go binaries as fast and easily as possible.   [![There was an update last month][G]](https://github.com/goreleaser/goreleaser)   [![godoc][D]](https://godoc.org/github.com/goreleaser/goreleaser)
...
- [sesh](https://github.com/joshmedeski/sesh) **star:2684** Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.   [![There was an update last month][G]](https://github.com/joshmedeski/sesh)   [![godoc][D]](https://godoc.org/github.com/joshmedeski/sesh)
...
- [jump](https://github.com/gsamokovarov/jump) **star:1935** Jump helps you navigate faster by learning your habits.   [![There was an update last month][G]](https://github.com/gsamokovarov/jump)   [![godoc][D]](https://godoc.org/github.com/gsamokovarov/jump)
...
- [validator](https://github.com/go-playground/validator) **star:20073** Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.   [![There was an update last month][G]](https://github.com/go-playground/validator)   [![godoc][D]](https://godoc.org/github.com/go-playground/validator)
- [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) **star:4110** Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.   [![godoc][D]](https://godoc.org/github.com/go-ozzo/ozzo-validation)
...
- [go-git](https://github.com/go-git/go-git) **star:7617** highly extensible Git implementation in pure Go.   [![There was an update last month][G]](https://github.com/go-git/go-git)   [![godoc][D]](https://godoc.org/github.com/go-git/go-git)
...
- [gortsplib](https://github.com/aler9/gortsplib) **star:929** Pure Go RTSP server and client library.   [![godoc][D]](https://godoc.org/github.com/aler9/gortsplib)
...
- [Gin](https://github.com/gin-gonic/gin) **star:88920** Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.   [![godoc][D]](https://godoc.org/github.com/gin-gonic/gin)
- [Fiber](https://github.com/gofiber/fiber) **star:39962** An Express.js inspired web framework build on Fasthttp.   [![There was an update last month][G]](https://github.com/gofiber/fiber)   [![godoc][D]](https://godoc.org/github.com/gofiber/fiber)
- [Echo](https://github.com/labstack/echo) **star:32528** High performance, minimalist Go web framework.   [![There was an update last month][G]](https://github.com/labstack/echo)   [![godoc][D]](https://godoc.org/github.com/labstack/echo)
...
- [GoFr](https://github.com/gofr-dev/gofr) **star:21159** Gofr is an opinionated microservice development framework.   [![There was an update last month][G]](https://github.com/gofr-dev/gofr)   [![godoc][D]](https://godoc.org/github.com/gofr-dev/gofr)
...
- [Hertz](https://github.com/cloudwego/hertz) **star:7303** A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices.   [![godoc][D]](https://godoc.org/github.com/cloudwego/hertz)   [![Contains Chinese documents][CN]](https://github.com/cloudwego/hertz)
- [Goa](https://github.com/goadesign/goa) **star:6090** Goa provides a holistic approach for developing remote APIs and microservices in Go.   [![godoc][D]](https://godoc.org/github.com/goadesign/goa)
...
- [chi](https://github.com/go-chi/chi) **star:22544** Small, fast and expressive HTTP router built on net/context.   [![godoc][D]](https://godoc.org/github.com/go-chi/chi)
...
- [tinygo](https://github.com/tinygo-org/tinygo) **star:17568** Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM.   [![There was an update last month][G]](https://github.com/tinygo-org/tinygo)   [![godoc][D]](https://godoc.org/github.com/tinygo-org/tinygo)
...
- [webhook](https://github.com/adnanh/webhook) **star:11973** Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.   [![godoc][D]](https://godoc.org/github.com/adnanh/webhook)
...
- [Dagu](https://github.com/dagu-go/dagu) **star:3635** No-code workflow executor. it executes DAGs defined in a simple YAML format.   [![There was an update last month][G]](https://github.com/dagu-go/dagu)   [![godoc][D]](https://godoc.org/github.com/dagu-go/dagu)
...
- [Cosign](https://github.com/sigstore/cosign) **star:6132** Container Signing, Verification and Storage in an OCI registry.   [![There was an update last month][G]](https://github.com/sigstore/cosign)   [![godoc][D]](https://godoc.org/github.com/sigstore/cosign)
...
- [kubernetes](https://github.com/kubernetes/kubernetes) **star:123817** Container Cluster Manager from Google.   [![There was an update last month][G]](https://github.com/kubernetes/kubernetes)   [![godoc][D]](https://godoc.org/github.com/kubernetes/kubernetes)
- [Moby](https://github.com/moby/moby) **star:71926** Collaborative project for the container ecosystem to assemble container-based systems.   [![There was an update last month][G]](https://github.com/moby/moby)   [![godoc][D]](https://godoc.org/github.com/moby/moby)
- [traefik](https://github.com/containous/traefik) **star:64006** Reverse proxy and load balancer with support for multiple backends.   [![There was an update last month][G]](https://github.com/containous/traefik)   [![godoc][D]](https://godoc.org/github.com/containous/traefik)
- [Gitea](https://github.com/go-gitea/gitea) **star:56837** Fork of Gogs, entirely community driven.   [![There was an update last month][G]](https://github.com/go-gitea/gitea)   [![godoc][D]](https://godoc.org/github.com/go-gitea/gitea)   [![Contains Chinese documents][CN]](https://github.com/go-gitea/gitea)
...
- [k9s](https://github.com/derailed/k9s) **star:34133** Kubernetes CLI to manage your clusters in style.   [![There was an update last month][G]](https://github.com/derailed/k9s)   [![godoc][D]](https://godoc.org/github.com/derailed/k9s)
- [k3s](https://github.com/k3s-io/k3s) **star:33476** Lightweight Kubernetes.   [![There was an update last month][G]](https://github.com/k3s-io/k3s)   [![godoc][D]](https://godoc.org/github.com/k3s-io/k3s)
- [minikube](https://github.com/kubernetes/minikube) **star:31954** Run Kubernetes locally.   [![There was an update last month][G]](https://github.com/kubernetes/minikube)   [![godoc][D]](https://godoc.org/github.com/kubernetes/minikube)
- [k6](https://github.com/grafana/k6) **star:31030** A modern load testing tool, using Go and JavaScript.   [![There was an update last month][G]](https://github.com/grafana/k6)   [![godoc][D]](https://godoc.org/github.com/grafana/k6)
- [colima](https://github.com/abiosoft/colima) **star:29935** Container runtimes on macOS (and Linux) with minimal setup.   [![There was an update last month][G]](https://github.com/abiosoft/colima)   [![godoc][D]](https://godoc.org/github.com/abiosoft/colima)
...
- [Hey](https://github.com/rakyll/hey) **star:20185** Hey is a tiny program that sends some load to a web application.   [![godoc][D]](https://godoc.org/github.com/rakyll/hey)
...
- [kind](https://github.com/kubernetes-sigs/kind) **star:15365** Kubernetes IN Docker - local clusters for testing Kubernetes.   [![There was an update last month][G]](https://github.com/kubernetes-sigs/kind)   [![godoc][D]](https://godoc.org/github.com/kubernetes-sigs/kind)
- [kubeshark](https://github.com/kubeshark/kubeshark) **star:12000** API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.   [![There was an update last month][G]](https://github.com/kubeshark/kubeshark)   [![godoc][D]](https://godoc.org/github.com/kubeshark/kubeshark)
...
- [script](https://github.com/bitfield/script) **star:7010** Making it easy to write shell-like scripts in Go for DevOps and system administration tasks.   [![godoc][D]](https://godoc.org/github.com/bitfield/script)
...
- [Fleet device management](https://github.com/fleetdm/fleet) **star:6583** Lightweight, programmable telemetry for servers and workstations.   [![There was an update last month][G]](https://github.com/fleetdm/fleet)   [![godoc][D]](https://godoc.org/github.com/fleetdm/fleet)
- [k3d](https://github.com/k3d-io/k3d) **star:6492** Little helper to run CNCF's k3s in Docker.   [![There was an update last month][G]](https://github.com/k3d-io/k3d)   [![godoc][D]](https://godoc.org/github.com/k3d-io/k3d)
- [k0s](https://github.com/k0sproject/k0s) **star:6336** Zero Friction Kubernetes distribution.   [![There was an update last month][G]](https://github.com/k0sproject/k0s)   [![godoc][D]](https://godoc.org/github.com/k0sproject/k0s)
...
- [Pomerium](https://github.com/pomerium/pomerium) **star:4912** Pomerium is an identity-aware access proxy.   [![There was an update last month][G]](https://github.com/pomerium/pomerium)   [![godoc][D]](https://godoc.org/github.com/pomerium/pomerium)
...
- [ghorg](https://github.com/gabrie30/ghorg) **star:2093** Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket.   [![There was an update last month][G]](https://github.com/gabrie30/ghorg)   [![godoc][D]](https://godoc.org/github.com/gabrie30/ghorg)
...
- [croc](https://github.com/schollz/croc) **star:35563** Easily and securely send files or folders from one computer to another.   [![There was an update last month][G]](https://github.com/schollz/croc)   [![godoc][D]](https://godoc.org/github.com/schollz/croc)
- [restic](https://github.com/restic/restic) **star:35019** De-duplicating backup program.   [![There was an update last month][G]](https://github.com/restic/restic)   [![godoc][D]](https://godoc.org/github.com/restic/restic)
...
- [JuiceFS](https://github.com/juicedata/juicefs) **star:14202** Distributed POSIX file system built on top of Redis and AWS S3.   [![There was an update last month][G]](https://github.com/juicedata/juicefs)   [![godoc][D]](https://godoc.org/github.com/juicedata/juicefs)
- [Juju](https://jujucharms.com/)  Cloud-agnostic service deployment and orchestration - supports EC2, Azure, Openstack, MAAS and more.
- [Layli](https://layli.app)  Draw pretty layout diagrams as code.
- [toxiproxy](https://github.com/shopify/toxiproxy) **star:12156** Proxy to simulate network and system conditions for automated tests.   [![There was an update last month][G]](https://github.com/shopify/toxiproxy)   [![godoc][D]](https://godoc.org/github.com/shopify/toxiproxy)
...
- [scc](https://github.com/boyter/scc) **star:8535** Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.   [![There was an update last month][G]](https://github.com/boyter/scc)   [![godoc][D]](https://godoc.org/github.com/boyter/scc)
...
- [Backrest](https://github.com/garethgeorge/backrest) **star:6920** Web-based UI and orchestrator for restic backup.   [![There was an update last month][G]](https://github.com/garethgeorge/backrest)
- [Better Go Playground](https://goplay.tools)  Go playground with syntax highlight, code completion and other features.
- [blocky](https://github.com/0xERR0R/blocky) **star:6787** Fast and lightweight DNS proxy as ad-blocker for local network with many features.   [![There was an update last month][G]](https://github.com/0xERR0R/blocky)   [![godoc][D]](https://godoc.org/github.com/0xERR0R/blocky)
...
- [Gokapi](https://github.com/Forceu/gokapi) **star:2801** Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload.   [![There was an update last month][G]](https://github.com/Forceu/gokapi)   [![godoc][D]](https://godoc.org/github.com/Forceu/gokapi)
...
- [CrunchyCleaner](https://github.com/Knuspii/CrunchyCleaner) **star:110** A lightweight, software cache cleanup tool for Windows & Linux.   [![There was an update last month][G]](https://github.com/Knuspii/CrunchyCleaner)   [![godoc][D]](https://godoc.org/github.com/Knuspii/CrunchyCleaner)
...
- [go-clean-template](https://github.com/evrone/go-clean-template) **star:7624** Clean Architecture template for Golang services.   [![There was an update last month][G]](https://github.com/evrone/go-clean-template)   [![godoc][D]](https://godoc.org/github.com/evrone/go-clean-template)
